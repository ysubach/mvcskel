...
* @package    MvcSkel
*/
class MvcSkel_UrlFactory_Action extends MvcSkel_UrlFactory {
    /**
     * Constructs action url object and returns it
     * @param $actionName name of action link to that is constructed
